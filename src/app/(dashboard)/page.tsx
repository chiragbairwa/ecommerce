    ...
    <div className='md:w-64 w-80 h-42'>
      <div className="relative bg-gray-200 rounded">
        ...
        <div className="p-1 bg-gray-100 rounded-full absolute top-2 right-2">
          <svg className="w-5 h-5 text-gray-800 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 21 19">
      ...
      <div className="flex my-1 justify-between items-center">
        <div className="flex items-center">
          {
            [...Array(Math.round(productData.rating.rate))].map( (item, i)=>{
              return (
                <svg key={`${i}-stars`} className="w-4 h-4 text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
        ...
        <button className="rounded px-3 py-1 border-2 font-medium hover:bg-gray-200" 
