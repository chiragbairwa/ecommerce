...
const Burger = () => {
	...
	return (
		<div className="md:hidden relative z-50 flex items-center">
			...
			>
				<div
					className={`relative flex overflow-hidden items-center justify-center rounded w-[40px] h-[40px] transform transition-all bg-slate-700 ring-0 ring-gray-300 hover:ring-8 group-focus:ring-4 ring-opacity-30 duration-200 shadow-md`}
				>
			...
			<div
				...
				} absolute mt-2 top-10 right-0 rounded bg-white border w-72 py-3 px-2`}
			>
				<SearchBar />
