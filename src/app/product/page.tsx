        ...
        <div className='w-1/2 pl-12'>
            ...
            <div className="flex mb-4 mt-2 items-center">{
                ...
                <div className='flex mb-4'>
                  ...
                  <div className='ml-4 text-sm'>
                    <p className="flex">Only 
                      <p className='text-orange-300 mx-1'>12 Items</p> 
                      Left!
                    </p>
                    <p>Don't miss it</p>
                  </div>
                ...
                <div className='flex gap-4 '>
                  <button className="bg-green-800 hover:bg-green-700 text-white px-16 py-2 rounded-full w-fit">
                    Buy Now  
                  </button>
                  <button className="border border-green-800 hover:bg-green-800 hover:text-white text-green-800 px-16 py-2 rounded-full w-fit">
                    Add to Cart  
                  </button>
                </div>
